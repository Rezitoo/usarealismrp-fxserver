...
supportedVehicles = {
    ...
    { name = "Chevrolet C6 ZR1", model = "vanzc6zr1", class = "A"},
    { name = "Chevrolet Camaro ZL1", model = "vanzczl1", class = "A"},
    { name = "Dodge Charger Daytona", model = "vanzdchar", class = "A"},
    -- B Class:**
    ...
    { name = "Chevrolet 2500", model = "fm11silv", class = "B"},
    -- C Class:**
