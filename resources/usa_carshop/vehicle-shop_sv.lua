	...
	["vehicles"] = {
      ...
      {make = "Trailer", model = "Closed", price = 80000, hash = "ctrailer", storage_capacity = 400.0},
		...
		["Custom"] = {
			...
			{make = "BMW", model = "G82 M4 2022", price = 250000, hash = "m422", storage_capacity = 180.0},
			{make = "BMW", model = "M5 Sport 2022", price = 250000, hash = "22m5", storage_capacity = 180.0},
			--
			...
			{make = "Cadillac", model = "CT5 Blackwing (2022)", price = 200000, hash = "ct5v", storage_capacity = 220.0},
			...
			{make = "Chevrolet", model = "Silverado 1500 (Lowered)", price = 65000, hash = "loweyezv", storage_capacity = 200.0},
